...
export const ContactForm = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      // Firebase integration placeholder logic
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
          ...
          >
            ...
            <div className="space-y-10 mb-16">
              {[
                { icon: <Mail className="w-6 h-6" />, label: "Direct Email", value: "kushwahaanish25@gmail.com", href: "mailto:kushwahaanish25@gmail.com" },
            ...
            <div className="flex flex-wrap items-center gap-4">
              {[
                { icon: <SocialLogos.LinkedIn />, href: "https://www.linkedin.com/in/anish-kushwaha-1a6aa0277?utm_source=share_via&utm_content=profile&utm_medium=member_android", color: "hover:bg-[#0077B5] hover:border-[#0077B5]" },
                ...
                <a 
                  ...
                  className={`p-4 bg-white border border-slate-200 rounded-2xl text-slate-600 hover:text-white transition-all shadow-sm ${social.color}`}
                >
                  {social.icon}
                </a>
              ))}
